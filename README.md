<!-- README para Analista de Dados - Skeleton pronto para preencher -->
...
- **ETL & Integração:** extração de dados, pipelines de automação, scripts básicos  
- **Boas práticas:** organização de dados, documentação e versionamento (Git opcional)
